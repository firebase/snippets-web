...
async function passwordSignInWithTenantDemo(auth, email, password) {
...
async function signUpWithTenant(auth, email, password) {
...
async function passwordSignInWithTenant(auth, email, password) {
...
async function samlSignInPopupTenant(auth, provider) {
...
async function samlSignInRedirectTenant(auth, provider) {
...
async function sendSignInLinkToEmailTenant(auth, email, actionCodeSettings) {
...
async function signInWithEmailLinkTenant(auth) {
...
async function signInWithCustomTokenTenant(auth, token) {
...
async function linkAccountTenant(auth, provider, email, password) {
...
async function accountExistsPopupTenant(auth, samlProvider, googleProvider, goToApp) {
...
async function accountExistsRedirectTenant(auth, samlProvider, googleProvider, goToApp) {
